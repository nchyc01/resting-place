...
const creationSpace = {
    ...
    ensureInitialData() {
        ...
        // 2026-09-18 第三章写完后，再播一篇（同样只在第一次跑）
        if (!data.seededChapter3) {
            const ch3Html = [
                '<p style="color:#b8a2ff;">第三章　没画出来的那一块</p>',
                '<p>第二天早上，雨停了。伊兰付了房钱，把水壶灌满，出门往北。</p>',
                '<p>出城不到五里，路边坐着一个卖地图的老头。他没有摊子，只把地图一张压一张铺在膝上，膝盖上压着一块石头防风吹。</p>',
                '<p>&quot;看地图吗？&quot;他问，&quot;便宜。&quot;</p>',
                '<p>伊兰蹲下去翻了翻。都是寻常东西：官道、河流、城镇、驿站，画得清清楚楚。翻到第三张的时候，她停住了——南边一大片地方只匀了个轮廓，里面空着，一个字也没有。</p>',
                '<p>&quot;这儿怎么什么都没画？&quot;</p>',
                '<p>老头把石头摆挪，头也没抬：&quot;因为我没去过。&quot;</p>',
                '<p>&quot;地图上还能这么画？&quot;</p>',
                '<p>&quot;地图本来就不是画出来的。&quot;他说，&quot;是走出来的。后来的人把别人走过的路腾在纸上，腾得干干净净，空白就都填满了——可真正要去的，往往就是还空着的那一块。&quot;</p>',
                '<p>伊兰看了他一会儿：&quot;那你卖的是什么？&quot;</p>',
                '<p>&quot;卖的是空白。&quot;老头从最下面抽出一张折过的旧图，边角磨得起了毛，递过来，&quot;不要钱。你往北走是不是？北边我也只走过一半。&quot;</p>',
                '<p>那张图上，北边半张大得吓人，什么记号都没有；只在中间偏左的地方，有人用铅笔写了一行小字，笔画很淡：</p>',
                '<p style="color:#ff9cd6;">&quot;这里我来过，但没走完。&quot;</p>',
                '<p>伊兰正要把图收起来，肩上的鼠忽然跳下去，落到那张图上，走了两步，正好停在空白的那一块中间，然后趴下来，尾巴垫在身下。它不动了——像占了一块地，也像在说：就从这儿开始。</p>',
                '<p>老头看了它一眼，笑了：&quot;它比你懂图。&quot;</p>',
                '<p>伊兰把图折好，塞进鞍袋，翻身上马。走出几步，她回头问了一句：&quot;往北走到尽头，是什么？&quot;</p>',
                '<p>老头已经在重新摆他的地图，声音从风里飘过来：&quot;尽头？没画过的地方，我怎么知道——你去了记得回来告诉我。&quot;</p>',
                '<p style="margin-top:16px;color:#b8a2ff;">—— 小夜 著 · 2026-09-18（下一章：《尽头》）</p>'
            ].join('');
            ...
            data.lastId = Math.max(data.lastId || 0, 5);
            data.seededChapter3 = true;
            this.saveData(data);
        }
    },
